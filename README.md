...
5. Make sure you have the version 1.0.0-beta.1 of `nargo`. You can check by running `nargo --version`. If you have a different version, you can use `noirup -v 1.0.0-beta.1`. And if you don't have `noirup` follow the instructions [here](https://noir-lang.org/docs/getting_started/installation/).
...
The latest supported version of Noir is 1.0.0-beta.1 with Barretenberg 0.67 as backend.
