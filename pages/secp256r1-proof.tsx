...
export default function Secp256r1Proof() {
  ...
  const onGenerateProof = async () => {
    if (!message) {
      Alert.alert('Invalid input', 'Please enter the message first');
      return;
    }
    ...
    try {
      ...
      setResult(bytesToHex(signature));
  ...
  return (
    <MainLayout canGoBack={true}>
      <Text
        ...
        Sign a message using the secure enclave and prove that you you sign the
        message with the key pair generated by the secure enclave
      </Text>
